...
class LXShowListCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        tLabel.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(viewClick)))
    }
    ...
    required init?(coder: NSCoder) {
     ...
     public lazy var tLabel: UILabel = {
         ...
         tLabel.font = UIFont.systemFont(ofSize: 16).fitFont
    ...
    override func layoutSubviews() {
        ...
        tLabel.frame = CGRect(x: LXFit.fitFloat(12), y: 0, width: bounds.width - LXFit.fitFloat(24), height: bounds.height - LXFit.fitFloat(0.5))
        lineView.frame = CGRect(x: 0, y: tLabel.frame.maxY, width: bounds.width, height: LXFit.fitFloat(0.5))
    }
}
